...
class GitHubReleaser(object):
    _API_URL = 'https://api.github.com/repos/poptong/youtubedl-lazy/releases'
    _UPLOADS_URL = 'https://uploads.github.com/repos/poptong/youtubedl-lazy/releases/%s/assets?name=%s'
